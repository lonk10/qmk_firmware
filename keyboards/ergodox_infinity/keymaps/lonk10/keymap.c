 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   | Left | Right|   `  | LAlt | LCtrl|                                       | Left | Down |  Up  | Right| RGui |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | \    | LGui |       | RAlt |  Del |
 *                                 ,------|------|------|       |------+--------+------.
 *                                 |      |      | Home |       | PgUp |        |      |
 *                                 | Space|Enter |------|       |------| RCtrl  |Bspace|
 *                                 |      |      | End  |       | PgDn |        |      |
 *                                 `--------------------'       `----------------------'
 */
...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,        CTL_T(KC_Z),  KC_X,   KC_C,   KC_V,   KC_B,   MO(SYMB),
        KC_LEFT,KC_RGHT,      KC_GRAVE,  KC_LALT,KC_LCTRL,
                                              KC_BSLASH,  KC_LGUI,
                                                              KC_HOME,
        ...
        // right hand
             ...
             KC_RALT,        KC_RCTRL,
             KC_PGUP,
             KC_PGDN,KC_DEL, KC_BSPACE
    ),
/* Keymap 1: Symbol Layer
 *
 * ,---------------------------------------------------.           ,--------------------------------------------------.
 * |Reset    |  F1  |  F2  |  F3  |  F4  |  F5  |      |           | Reset|  F6  |  F7  |  F8  |  F9  |  F10 |   F11  |
 * |---------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
 * |         |   !  |   @  |   {  |   }  |   |  |      |           |      |   Up |   7  |   8  |   9  |   *  |   F12  |
 * |---------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |         |   #  |   $  |   (  |   )  |   `  |------|           |------| Down |   4  |   5  |   6  |   +  |        |
...
[SYMB] = LAYOUT_ergodox(
       ...
       // right hand
       RESET, KC_F6,   KC_F7,  KC_F8,   KC_F9,   KC_F10,  KC_PSCR,
